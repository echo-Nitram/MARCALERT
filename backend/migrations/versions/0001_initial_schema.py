...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "tier",
            postgresql.ENUM("starter", "pro", "estudio", name="subscriptiontier", create_type=False),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "tipo",
            postgresql.ENUM("denominativa", "figurativa", "mixta", name="tipomarca", create_type=False),
            nullable=False,
        ...
        sa.Column(
            "sensibilidad",
            postgresql.ENUM("bajo", "medio", "alto", name="sensibilidadumbral", create_type=False),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "estado",
            postgresql.ENUM("nueva", "revisada", "en_oposicion", "descartada", name="estadoalerta", create_type=False),
            nullable=False,
